...
export class ChatroomPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.chatroomSubscription = this.db
  ...
  addChat() {
    if (this.message && this.message !== "") {
      ...
      this.chatPayload = {
        ...
        sender: this.chatuser.userId,
        receiver: this.chatService.currentChatPartner.userId,
  ...
  isChatPartner(senderEmail) {
    return senderEmail == this.chatpartner.userId;
  } //isChatPartner

  ngOnDestroy(){

    if(this.chatroomSubscription !== undefined){
      this.chatroomSubscription.unsubscribe();
      this.chatroomSubscription = undefined;
    }
